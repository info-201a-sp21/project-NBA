...
Ave_FG_PTC_away <- NBA_games_2019 %>%
  select(FG_PCT_away) %>%
  summarize(
    count = n(),
...
Ave_FG3_PCT_home <- NBA_games_2019 %>%
  select(FG3_PCT_home) %>%
  summarize(
    count = n(),
...
Ave_FG3_PCT_away <- NBA_games_2019 %>%
  select(FG3_PCT_away) %>%
  summarize(
    count = n(),
