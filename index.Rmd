...
chart1(games_data)
```
This chart was intended to visualize and compare how top8 teams who have the highest Field Goal percentage in general perform in their home and away games. The grouped bar chart shows clearly the difference between each team's Field Goal percentage in their home and away games. 
**Insights:**
